...
!          epot = ce*(temp-tt)*epotcorr
  ...
  SUBROUTINE evaporation_percolation_soilrunoff_linear_reservoir(i,j,temp,epot,wp,fc,epotfrac,soilstate,evap,evapflows,cevap,barefrac, &
    ...
    USE MODVAR, ONLY : basin,soilthick,realzero, &
					   ...
					   timesteps_per_day														!!Added by BTW JUly12_2020
    USE HYPEVARIABLES, ONLY : basinlp, &
                              m_ttmp,  &
...
!write(49002,*)S_new(3),
	...
	perc1= Min(soilpar(m_perc1,isoil)*									&
     ...
     &	Max(0.,(wp(2)+fc(2)+ep(2)) - soilstate%water(2,j,i)))
	...
	soilrunoff(1) = Max(0.,soilstate%water(1,j,i)-fc(1)-wp(1))*soilrc(1,j,i)
...
!###############################
	...
	perc2=Min(soilpar(m_perc2,isoil)*									&
     ...
     &	Max(0.,(wp(3)+fc(3)+ep(3)) - soilstate%water(3,j,i)))
	...
	soilrunoff(2) = Max(0.,soilstate%water(2,j,i)-fc(2)-wp(2))*soilrc(2,j,i)
...
evap2 = MIN(1.,barefrac)*epot*epotfrac(2)*soiltemp_reduction(2)*&
	 &	Min(1.,(Max(0.,soilstate%water(2,j,i)-wp(2))/(basinlp(i)*fc(2))))
...
!###########################
	...
	soilstate%conc(:,3,j,i) = (soilstate%conc(:,3,j,i)*S_t0(3)+			&
	 ...
	 call deAllocate_mat_inv_variables
	  ...
	  soilrunoff(3) = Max(0.,soilstate%water(3,j,i)-fc(3)-wp(3))*soilrc(3,j,i)
